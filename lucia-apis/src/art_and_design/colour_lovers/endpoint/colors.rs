...
_create_endpoint! {
  ...
  ColorsParams(
    ...
    |_hp| {
      ...
      match ty {
        CommonReqTy::All => _hp.tp.url_parts.set_path(format_args!("/api/colors"))?,
        CommonReqTy::New => _hp.tp.url_parts.set_path(format_args!("/api/colors/new"))?,
        CommonReqTy::Random => _hp.tp.url_parts.set_path(format_args!("/api/colors/random"))?,
        CommonReqTy::Top => _hp.tp.url_parts.set_path(format_args!("/api/colors/top"))?,
      }
