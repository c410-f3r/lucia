...
_create_endpoint! {
  ...
  PalettesParams(
    ...
    |_hp| {
      ...
      match ty {
        CommonReqTy::All => _hp.tp.url_parts.set_path(format_args!("/api/palettes"))?,
        CommonReqTy::New => _hp.tp.url_parts.set_path(format_args!("/api/palettes/new"))?,
        CommonReqTy::Random => _hp.tp.url_parts.set_path(format_args!("/api/palettes/random"))?,
        CommonReqTy::Top => _hp.tp.url_parts.set_path(format_args!("/api/palettes/top"))?,
      }
