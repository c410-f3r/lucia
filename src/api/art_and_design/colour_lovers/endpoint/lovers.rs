...
_create_endpoint! {
  ...
  LoversParams(
    ...
    |_hp| {
      ...
      match ty {
        LoversTy::All => _hp.tp._url_parts.set_path(format_args!("/api/lovers"))?,
        LoversTy::New => _hp.tp._url_parts.set_path(format_args!("/api/lovers/new"))?,
        LoversTy::Top => _hp.tp._url_parts.set_path(format_args!("/api/lovers/top"))?,
      }
