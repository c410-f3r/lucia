...
_create_endpoint! {
  ...
  PatternsParams(
    ...
    |_hp| {
      ...
      match ty {
        CommonReqTy::All => _hp.tp._url_parts.set_path(format_args!("/api/patterns"))?,
        CommonReqTy::New => _hp.tp._url_parts.set_path(format_args!("/api/patterns/new"))?,
        CommonReqTy::Random => _hp.tp._url_parts.set_path(format_args!("/api/patterns/random"))?,
        CommonReqTy::Top => _hp.tp._url_parts.set_path(format_args!("/api/patterns/top"))?,
      }
