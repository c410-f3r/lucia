use crate::data_format::GraphQlResponseError;
use alloc::vec::Vec;
...
#[cfg(feature = "serde")]
mod serde {
  use crate::data_format::{GraphQlResponse, GraphQlResponseError};
  use alloc::vec::Vec;
...
mod serde_json {
  ...
  impl<D, E> crate::dnsn::Deserialize<SerdeJson> for GraphQlResponse<D, E>
  where
  ...
  impl<D, E> crate::dnsn::Serialize<SerdeJson> for GraphQlResponse<D, E>
  where
    D: serde::Serialize,
    E: serde::Serialize,
  {
...
mod simd_json {
  use crate::{data_format::GraphQlResponse, dnsn::SimdJson, misc::ByteBuffer};
  use core::fmt::Display;

  impl<D, E> crate::dnsn::Deserialize<SimdJson> for GraphQlResponse<D, E>
  where
    D: for<'de> serde::Deserialize<'de>,
    E: for<'de> serde::Deserialize<'de>,
  {
  ...
  impl<D, E> crate::dnsn::Serialize<SimdJson> for GraphQlResponse<D, E>
  where
    D: serde::Serialize,
    E: serde::Serialize,
  {
